...
function EditorPanel() {
  ...
  return (
    <div className="w-full max-w-screen overflow-hidden px-2 sm:px-4">
      <div className="relative bg-[#12121a]/90 backdrop-blur rounded-xl border border-white/[0.05] p-4 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
          ...
          <div className="flex flex-row items-start sm:items-center gap-3 w-full sm:w-auto">
            {/* Font Size */}
            <div className="flex items-center gap-2 px-3 py-2 bg-[#1e1e2e] rounded-lg ring-1 ring-white/5 w-full sm:w-auto">
            ...
            <motion.button
              ...
              className="p-2 mx-auto bg-[#1e1e2e] hover:bg-[#2a2a3a] rounded-lg ring-1 ring-white/5 transition-colors"
            ...
            <motion.button
              ...
              className="w-20 mx-auto sm:w-auto inline-flex items-center justify-center gap-2 px-3 py-2 rounded-md overflow-hidden text-sm 
