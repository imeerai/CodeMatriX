    ...
    <div className="relative z-10">
      <div
        className="flex flex-col lg:flex-row items-center justify-between
         bg-[#0a0a0f]/80 backdrop-blur-xl p-4 sm:p-5 md:p-6 mb-4 rounded-lg gap-4 sm:gap-6"
      >
        {/* Left side logo + nav */}
        ...
        {/* Right side controls */}
        <div className="flex flex-wrap justify-center sm:justify-end items-center gap-4 w-full lg:w-auto">
          <ThemeSelector />
          <LanguageSelector hasAccess={Boolean(convexUser?.isPro)} />
