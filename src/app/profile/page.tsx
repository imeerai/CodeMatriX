            ...
            <div className="flex space-x-1 p-2 sm:p-4">
              {TABS.map((tab) => (
                <button
                  ...
                  className={`group flex items-center gap-1 sm:gap-2 px-3 sm:px-6 py-2 sm:py-2.5 rounded-lg transition-all duration-200 relative overflow-hidden ${
                ...
                >
                  ...
                  <span className="text-xs sm:text-sm font-medium relative z-10">{tab.label}</span>
                </button>
              ))}
            </div>
          </div>
              ...
              {activeTab === "executions" && (
                <div className="space-y-4 sm:space-y-6">
                  {executions?.map((execution) => (
                    ...
                    >
                      <div className="flex items-center justify-between p-3 sm:p-4 bg-black/30 border border-gray-800/50 rounded-t-xl">
                      ...
                      <div className="p-3 sm:p-4 bg-black/20 rounded-b-xl border border-t-0 border-gray-800/50">
                        ...
                        {(execution.output || execution.error) && (
                          <div className="mt-4 p-3 sm:p-4 rounded-lg bg-black/40">
                  ...
                  {isLoadingExecutions ? (
                    ...
                    executions.length === 0 && (
                      <div className="text-center py-8 sm:py-12">
                        ...
                        <h3 className="text-base sm:text-lg font-medium text-gray-400 mb-2">No code executions yet</h3>
                        <p className="text-sm text-gray-500">Start coding to see your execution history!</p>
                      </div>
                    )
                  )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      ...
                      <Link href={`/snippets/${snippet._id}`}>
                        ...
                        >
                          <div className="p-4 sm:p-6">
                            <div className="flex items-center justify-between mb-4">
                              <div className="flex items-center gap-2 sm:gap-3">
                                ...
                                <span className="px-2 sm:px-3 py-1 bg-blue-500/10 text-blue-400 rounded-lg text-xs sm:text-sm">
                                  {snippet.language}
                                </span>
                              </div>
                              <div
                            ...
                            <h2 className="text-base sm:text-xl font-semibold text-white mb-2 sm:mb-3 line-clamp-1 group-hover:text-blue-400 transition-colors">
                              {snippet.title}
                            </h2>
                          ...
                          <div className="px-4 sm:px-6 pb-4 sm:pb-6">
                            <div className="bg-black/30 rounded-lg p-3 sm:p-4 overflow-hidden">
                              <pre className="text-xs sm:text-sm text-gray-300 font-mono line-clamp-3 overflow-x-auto">
                                {snippet.code}
                              </pre>
                            </div>
                          </div>
                  ...
                  {(!starredSnippets || starredSnippets.length === 0) && (
                    <div className="col-span-full text-center py-8 sm:py-12">
                      <Star className="w-8 h-8 sm:w-12 sm:h-12 text-gray-600 mx-auto mb-4" />
                      <h3 className="text-base sm:text-lg font-medium text-gray-400 mb-2">No starred snippets yet</h3>
                      <p className="text-sm text-gray-500">Start exploring and star the snippets you find useful!</p>
                    </div>
                  )}
                </div>
              )}
